...
# New class names
new_class_names = ['10h', '2h', '3h', '4h', '5h', '6h', '7h', '8h', '9h', 'Ah', 'Jh', 'Kh', 'Qh']

# Create a mapping from old to new class indices
old_to_new_class_index = {old_class_names.index(name): new_class_names.index(name) for name in new_class_names}

# Directories
dataset1_base_dir = 'dataset_combined'
...
for subdir in subdirs:
    label_dir = os.path.join(dataset1_base_dir, subdir, 'labels')
